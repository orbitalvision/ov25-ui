...
function App() {
  return (
    <TestPageLayout
      title="Configure Button — Modal (desktop)"
      description="Desktop opens configurator in a modal (no gallery on page; iframe preloaded, repositioned into modal). Mobile uses drawer."
      injectConfig={config}
