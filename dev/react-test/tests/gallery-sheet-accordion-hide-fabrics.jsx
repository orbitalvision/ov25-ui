...
const config = /** @type {import('ov25-ui').InjectConfiguratorInput} */ ({
  ...
  configurator: {
    ...
    variants: {
      displayMode: { desktop: 'accordion', mobile: 'accordion' },
...
function App() {
  return (
    <TestPageLayout
      title="Hide fabrics — Sheet + Accordion"
      description="Same as gallery sheet + accordion; fabric option omitted from variant UI (iframe default remains)."
      injectConfig={config}
      showProductTabs
    />
  );
