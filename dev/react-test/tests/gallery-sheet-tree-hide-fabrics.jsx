...
const config = /** @type {import('ov25-ui').InjectConfiguratorInput} */ ({
  ...
  configurator: {
    ...
    variants: {
      displayMode: { desktop: 'tree', mobile: 'tree' },
...
function App() {
  return (
    <TestPageLayout
      title="Hide fabrics — Sheet + Tree"
      description="Same as gallery sheet + tree; fabric option omitted from variant UI (iframe default remains)."
      injectConfig={config}
      showProductTabs
    />
  );
