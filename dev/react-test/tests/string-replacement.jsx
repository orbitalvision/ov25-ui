...
const injectConfig = /** @type {import('ov25-ui').InjectConfiguratorInput} */ ({
  ...
  stringReplacements: {
    ...
    groupPriceTotal: [{ template: '▽Group upgrade: ${PRICE}▽' }],
    groupPriceFromTotal: [{ template: '▽Group upgrade from: ${PRICE}▽' }],
    groupPriceInline: [{ template: ' - ▽${PRICE_LABEL}▽' }],
    ...
    swatchMetadataDescription: [{ template: '▽Description▽' }],
    swatchMetadataRange: [{ template: '▽Range▽' }],
    swatchMetadataSupplier: [{ template: '▽Supplier▽' }],
