...
const initializeConfigurator = () => {
  ...
  // Inject the configurator - Range with inline variant controls and grouped variants
  injectConfigurator({
    apiKey: () => { return '15-5f9c5d4197f8b45ee615ac2476e8354a160f384f01c72cd7f2638f41e164c21d' }, 
    productLink: () => { return 'range/126' }, // Arlo&Jacob - Otti range
...
function App() {
  ...
  return (
    <div className="app ">
      <h1>Range - Inline Variants with Groups</h1>
      <p>This test demonstrates the inline variant controls feature with a product range and grouped variants. The Arlo&Jacob - Otti range has multiple products with variant groups (e.g., fabric, leg finish) that will be displayed as expandable accordion sections.</p>
