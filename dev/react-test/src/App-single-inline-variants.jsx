...
function App() {
  ...
  return (
    <div className="app ">
      <h1>Single Product - Inline Variants</h1>
      <p>This test demonstrates the new inline variant controls feature. On desktop, variant options will be displayed as expandable accordion sections instead of opening a fullscreen drawer.</p>
