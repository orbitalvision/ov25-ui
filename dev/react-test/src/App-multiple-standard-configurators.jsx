...
const initializeConfigurator = () => {
  ...
  // Initialize multiple standard configurators
  injectMultipleConfigurators([
    ...
    {
      apiKey: '15-5f9c5d4197f8b45ee615ac2476e8354a160f384f01c72cd7f2638f41e164c21d',
      productLink: '1284', // Arlo&Jacob - Otti - Corner Unit
      galleryId: '#gallery-3',
      priceId: { id: '#price-3', replace: true },
      nameId: { id: '#name-3', replace: true },
      logoURL: 'https://ov25.orbital.vision/OV.png',
      addToBasketFunction: () => console.log('Add to basket - Product 3'),
      buyNowFunction: () => console.log('Buy now - Product 3'),
      addSwatchesToCartFunction: () => console.log('Add swatches to cart - Product 3'),
    },
    {
      apiKey: '15-5f9c5d4197f8b45ee615ac2476e8354a160f384f01c72cd7f2638f41e164c21d',
      productLink: '1287', // Arlo&Jacob - Otti - Grand Filler Unit
      galleryId: '#gallery-4',
      priceId: { id: '#price-4', replace: true },
      nameId: { id: '#name-4', replace: true },
      logoURL: 'https://ov25.orbital.vision/OV.png',
      addToBasketFunction: () => console.log('Add to basket - Product 4'),
      buyNowFunction: () => console.log('Buy now - Product 4'),
      addSwatchesToCartFunction: () => console.log('Add swatches to cart - Product 4'),
    }
  ]);
    ...
    <div className="app">
      ...
      <div className="configurators-grid">
        ...
        <div className="configurator-card">
          ...
          <div id="gallery-3" className="gallery-container"></div>
          <div className="product-info">
        ...
        <div className="configurator-card">
          ...
          <div id="gallery-4" className="gallery-container"></div>
          <div className="product-info">
