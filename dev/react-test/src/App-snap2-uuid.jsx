...
const initializeConfigurator = () => {
  ...
  // Inject the configurator - Snap2 with configurationUuid
  injectConfigurator({
    ...
    configurationUuid: () => { return '68245136-580c-4481-864c-1da82f3a50db' }, // Specific configuration UUID
    priceId: { id: '#price', replace: true },
    nameId: { id: '#name', replace: true },
    logoURL: 'https://ov25.orbital.vision/OV.png',
    hidePricing: false,
    // Snap2 configuration with specific UUID
  });
...
function App() {
  ...
  return (
    <div className="app ">
      <h1>Snap2 with Configuration UUID</h1>
