...
const initializeConfigurator = () => {
  ...
  // Inject the configurator - Range without groups
  injectConfigurator({
    apiKey: () => { return '15-5f9c5d4197f8b45ee615ac2476e8354a160f384f01c72cd7f2638f41e164c21d' }, 
    productLink: () => { return 'range/85' }, // Ponti (Non Grouped)
    ...
    hidePricing: false,
    // This is a range without grouped variants
  });
