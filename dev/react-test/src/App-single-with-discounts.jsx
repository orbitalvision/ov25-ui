...
const initializeConfigurator = () => {
  ...
  // Inject the configurator - Single product with discounts
  injectConfigurator({
    apiKey: () => { return '15-5f9c5d4197f8b45ee615ac2476e8354a160f384f01c72cd7f2638f41e164c21d' }, 
    productLink: () => { return '948' }, // Whitemeadow - Bergen - 1 Arm Chaise Unit RHF
...
function App() {
  ...
  return (
    <div className="app ">
      <h1>Single Product - With Discounts</h1>
