...
export const STYLE_GROUPS: StyleGroup[] = [
  {
    ...
    description: 'Checkout, configure, and option selector buttons',
    variables: [
      { variable: '--ov25-cta-color', label: 'CTA button color', defaultValue: '#22c55e', control: 'color' },
      { variable: '--ov25-cta-color-hover', label: 'CTA hover color', defaultValue: '#16a34a', control: 'color' },
      { variable: '--ov25-cta-color-light', label: 'CTA disabled tint', defaultValue: '#4ade80', control: 'color' },
      { variable: '--ov25-cta-border-radius', label: 'CTA button corners', defaultValue: '9999px', control: 'corner' },
      { variable: '--ov25-cta-text-color', label: 'CTA text color', defaultValue: '#ffffff', control: 'color' },
      { variable: '--ov25-primary-color', label: 'Option button color', defaultValue: '#414141', control: 'color' },
      { variable: '--ov25-button-border-radius', label: 'Option button corners', defaultValue: '0px', control: 'corner' },
      { variable: '--ov25-button-border-width', label: 'Option button border', defaultValue: '1px', control: 'slider', sliderMin: 0, sliderMax: 4, sliderStep: 0.5, sliderUnit: 'px', sliderLabels: ['None', 'Thick'] },
      { variable: '--ov25-button-border-color', label: 'Option border color', defaultValue: '#E5E5E5', control: 'color' },
      { variable: '--ov25-button-text-color', label: 'Option text color', defaultValue: '#ffffff', control: 'color' },
      { variable: '--ov25-button-hover-background-color', label: 'Option hover fill', defaultValue: '#fafafa', control: 'color' },
      { variable: '--ov25-button-hover-text-color', label: 'Option hover text', defaultValue: '#000000', control: 'color' },
    ],
  },
  {
    id: 'colors',
    label: 'Colors & Theme',
    description: 'Background, text, border, and accent colors used everywhere',
    variables: [
      ...
      { variable: '--ov25-highlight-color', label: 'Accent / highlight', defaultValue: '#00fbff', control: 'color' },
  ...
  {
    id: 'shapes',
    label: 'Shapes & Corners',
    description: 'Border radius for the gallery, thumbnails, and global rounding scale',
    variables: [
      { variable: '--ov25-configurator-iframe-border-radius', label: 'Gallery corners', defaultValue: '1rem', control: 'corner' },
      { variable: '--ov25-variant-thumb-border-radius', label: 'Thumbnail shape', defaultValue: '9999px', control: 'corner' },
  ...
  },
  {
    ...
    description: '3D viewer container, carousel spacing, and overlay button colors',
    variables: [
  ...
  },
  {
    ...
    description: 'Font sizes, font family, product title/price colors, and panel heights',
    variables: [
