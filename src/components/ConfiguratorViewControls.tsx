...
import { Ruler as DimensionsIcon, RulerDimensionLineIcon } from 'lucide-react'
...
const ConfiguratorViewControls: React.FC<ConfiguratorViewControlsProps> = ({
  ...
  return (
    ...
    <div className={cn(
      ...
      {!isVariantsOpen && !isMobile && (<div className="ov:absolute ov:ov25-controls-hidden ov:size-full ov:md:flex ov:pointer-events-none ov:inset-0 ov:p-4 ov:justify-end ov:items-start ov:z-[101]">
          <button className={cn(
