  ...
  return (
    ...
    >
      ...
      {!isSnap2CheckoutSheetOpen && !hidePricing && hasCheckout ? (
        <div className="ov25-checkout-button-wrapper ov:shrink-0 ov:w-full ov:min-w-0 ov:max-w-full ov:bg-(--ov25-background-color) ov:px-4 ov:pb-2 ov:md:px-4 ov:md:pb-2 ov:pt-2">
          <button
            type="button"
