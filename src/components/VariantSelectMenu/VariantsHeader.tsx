...
export const VariantsHeader = () => {
    ...
    return (
      <>
        ...
        <div id="ov25-carousel-controls" className="ov:relative ov:flex ov:cursor-pointer ov:md:hidden ov:items-center ov:justify-between ov:w-full ov:p-4 ov:py-[1.125rem] ov:pt-6">
