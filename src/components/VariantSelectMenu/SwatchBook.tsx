...
export const SwatchBook: React.FC<SwatchBookProps> = ({
  ...
  return (
    <Dialog open={isSwatchBookOpen} onOpenChange={handleDialogOpenChange}>
      <DialogContent id="ov25-swatchbook" className="ov:flex ov:flex-col ov:p-2 ov:md:p-6 ov:bg-white ov:border-none ov:max-w-[95vw] ov:md:max-w-[700px] ov:h-[90vh] ov:max-h-[90vh] ov:md:h-[800px] ov:mx-auto ov:my-2 ov:md:m-0 ov:overflow-hidden" aria-describedby={undefined} closeClassName="ov:hidden">
        ...
        <div className="ov:flex ov:flex-col ov:min-h-0 ov:h-full">
          ...
          <div id="ov25-swatchbook-controls" className="ov:flex ov:justify-between ov:items-center ov:shrink-0">
            ...
            <div id="ov25-swatchbook-add-to-cart-button" className="ov:flex ov:gap-2">
              <Button
                id="ov25-swatchbook-add-button"
                variant="success"
                className="ov:rounded-full ov:py-2 ov:px-6"
