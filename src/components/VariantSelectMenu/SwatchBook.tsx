            ...
            <div id="ov25-swatchbook-featured" className="ov:flex-shrink-0">
              <div className="ov:flex ov:flex-col ov:items-center ov:gap-4">
                ...
                <div className="ov:text-center">
                  <h3 className="ov:text-lg ov:font-medium ov:text-black ov:mb-1">{zoomedSwatch.name}</h3>
                  <p className="ov:text-gray-600 ov:text-xs ov:italic ov:mb-2">{zoomedSwatch.option}</p>
                  <p className="ov:text-black ov:text-sm ov:font-normal">{zoomedSwatch.description}</p>
                </div>
              </div>
            </div>
          )}
